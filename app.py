...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://classiq:pythonanywhereman.com@classiq.mysql.pythonanywhere-services.com/classiq$accounts'
...
app.config['MAIL_PASSWORD'] = 'jjazhprflkncdlqf'  # <-- app password, not Gmail password
